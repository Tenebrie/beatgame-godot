@tool
class_name BasicClawsStrikeEffect extends Node3D
...
func createSwipeTrail(from: Vector3, to: Vector3, arc: float) -> void:
	...
	trail.size_curve = preload("res://player/abilities/BasicClaws/BasicClawsStrikeTrailCurve.tres")
	trail.time_curve = preload("res://player/abilities/BasicClaws/BasicClawsStrikeTrailTimeCurve.tres")
	trail.color_gradient = preload("res://player/abilities/BasicClaws/BasicClawsStrikeTrailGradient.tres")
	trail.time_color_gradient = preload("res://player/abilities/BasicClaws/BasicClawsStrikeTrailTimeGradient.tres")
	add_child(trail)
